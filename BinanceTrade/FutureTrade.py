...
def getAssetUSDT():
    ...
    return int(result[3].balance) # API มีการเปลี่ยนแปลง ค่า index

#< แก้ไข เพิ่ม function 6-27-2021
def PlaceOrderAtMarket(position,symbol,amount,lev,act_price_percent=0.01,cb=1,stoploss_Percent =5):
    """
